...
export function makeHeader() {
	...
	logo.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
   <path
   ...
   `;
	...
	nav.innerHTML = `<a href="#" id="home-page">Home</a>
   <a href="#" id="menu-page">Menu</a>
   <a href="#" id="contact-page">Contact us</a>`;
}
...
export function makeFooter() {
	...
	link.setAttribute('href', 'https://github.com/Eliaskh77');
	link.innerText = ` Eliaskh77`;
